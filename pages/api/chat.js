...
const REALTIME_KEYWORDS = [
  ...
  'תשואת שכירות', 'דירה להשקעה', 'נדל"ן מניב',
  // Real estate - International
  'נדל"ן בחו"ל', 'דירה ביוון', 'דובאי', 'גאורגיה', 'פורטוגל', 'ספרד',
  'נדל"ן באמריקה', 'השקעה בחו"ל',
  // Stocks - General
  'מניה', 'מניות', 'בורסה', 'מדד', 'S&P', 'נאסד"ק', 'תל אביב 35',
  'ETF', 'דיבידנד', 'שוק ההון', 'מסחר', 'וול סטריט',
  // Stocks - AI & Tech
  'מניות AI', 'בינה מלאכותית', 'NVIDIA', 'נבידיה', 'מייקרוסופט', 'גוגל',
  'אמזון', 'אפל', 'טסלה', 'מטא', 'OpenAI', 'מניות טכנולוגיה', 'סמיקונדקטור',
  // Crypto
  ...
  'מיתון', 'צמיחה כלכלית', 'מיסוי', 'מס רכישה', 'מס שבח',
  // Savings & Pension
  'חיסכון', 'קרן השתלמות', 'פנסיה', 'ביטוח', 'קופת גמל',
  // Investment decisions
  'מניות או נדל"ן', 'איפה להשקיע', 'כדאי להשקיע', 'השקעה חודשית',
  'תיק השקעות', 'פיזור סיכונים', 'אסטרטגיית השקעה',
  // News triggers
  'היום', 'עכשיו', 'נוכחי', 'עדכני', 'אחרון', 'חדשות',
  'מלחמה', 'משבר', 'קריסה', 'שיא', 'עלייה', 'ירידה',
];
